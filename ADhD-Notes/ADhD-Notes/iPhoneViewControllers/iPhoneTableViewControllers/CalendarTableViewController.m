...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([[_fetchedResultsController objectAtIndexPath:indexPath] isKindOfClass:[SimpleNote class]]){
        SimpleNote *theSimpleNote = [_fetchedResultsController objectAtIndexPath:indexPath];
        cell.textLabel.textColor = [UIColor lightTextColor];
        cell.textLabel.text = theSimpleNote.text;
